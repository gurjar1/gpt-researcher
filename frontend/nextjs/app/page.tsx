...
export default function Home() {
  ...
  // Quick search hook
  const { isLoading: quickSearchLoading, answer: quickAnswer, sources: quickSources, query: quickQuery, error: quickError, search: quickSearch, reset: resetQuickSearch, conversationHistory: quickConversationHistory } = useQuickSearch();
        ...
        getAppropriateLayout({
          ...
          children: (
            <>
              ...
              {showQuickAnswer && (
                <div
                  className="mt-2 w-full max-w-4xl mx-auto px-2"
                  ref={(el) => {
                    if (el && quickSearchLoading) {
                ...
                >
                  <QuickAnswer
                    ...
                    error={quickError}
                    conversationHistory={quickConversationHistory}
                    onFollowUp={(followUpQuery) => {
                      quickSearch(followUpQuery, focusMode);
                    }}
                  />
                </div>
              )}
