...
Include inline citations using [1], [2], etc. to reference the sources within your text.
Be concise but comprehensive. Format your response in markdown.
IMPORTANT: Do NOT include a "References" section at the end. Only use inline citations like [1], [2]. The references will be displayed separately by the UI.
{history_text}
Search Results:
{sources_text}
...
Answer with inline citations only (no References section):"""
