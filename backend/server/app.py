...
from server.ollama_models import router as ollama_router
from server.ollama_pull import router as ollama_pull_router
from server.llm_backend_api import router as llm_backend_router
from server.pdf_extract import pdf_router
...
app.include_router(ollama_pull_router)
app.include_router(llm_backend_router)
